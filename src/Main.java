...
//- Förnamn och efternamn (separata variabler) - Ålder
//- Längd i meter
//- Vikt i kg
//- Om personen är student (ja/nej)
//2. Tilldela värden till alla variabler:
//- Välj lämplig datatyp för varje variabel
//- Skriv en kommentar vid varje variabel som förklarar ditt val av datatyp - Tänk på att längd behöver decimaler medan ålder är heltal
//3. Skriv ut informationen:
//- Använd System.out.println för varje utskrift
//- Testa både att skriva ut variabler direkt och att kombinera text med variabler - Experimentera med olika sätt att formatera utskrifterna
...
//- Vad händer om du försöker använda ett variabelnamn som börjar med en siffra? - Prova att deklarera flera variabler på samma rad - hur fungerar det?
...
//- Hur man gör enkel formatering av utskrifter - Grundläggande operatorer och beräkningar
//Tips:
//- Ta dig tid att experimentera med koden
//- Skriv kommentarer som förklarar vad du gör
//- Testa att göra samma sak på olika sätt
//- Försök medvetet skapa några fel för att se vad som händer - Var inte rädd för att testa dig fram